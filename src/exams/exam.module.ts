...
import { ExamSubmissionController } from './exam-submissions.controller';
...
@Module({
  ...
  providers: [ExamService, ExamSubmissionService, ExamSessionService, TeacherExamsService],
  exports: [ExamService, ExamSubmissionService, ExamSessionService, TeacherExamsService],
